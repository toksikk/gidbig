...
Public `/leetoclock top` uses plain cached display names (or neutral player numbers when unavailable), never player mentions. Private results can display player mentions without sending notifications.
